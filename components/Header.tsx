...
// ✅ Ahora permite rutas reales, no solo anclas
type NavItem = { label: string; href: string };

const nav: NavItem[] = [
  { label: "Inicio", href: "/" },
  { label: "CapiiWear", href: "/wear" }, // ajusta según el nombre de tu carpeta
  { label: "Somos", href: "/somos" },    // ✅ ahora abre la página /somos
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link href="/#contacto" className="drawer-cta">
            Contacto
          </Link>
        </nav>
      </aside>
      ...
      <style jsx>{`
        ...
        .hdr-burger .bar::before,
        .hdr-burger .bar::after {
          content: "";
          position: absolute;
          left: 0;
          width: 22px;
